...
function _saveQuestion(question) {
  return new Promise((res, rej) => {
    if (!question.optionOneText || !question.optionTwoText || !question.author) {
      rej("Question info not complete");
    }
...
function _saveQuestionAnswer({ authenticatedUser, qid, answer }) {
  return new Promise((res, rej) => {
    if (!authenticatedUser || !qid || !answer) {
      rej("Answer info not complete");
    }
    setTimeout(() => {
      users = {
        ...users,
