    ...
    return (
      <div className="container margin_60_35" style={{ minHeight: "calc(100vh - 155px)" }}>
        <div className="main_title_2" style={{ marginTop: "7rem" }}>
          ...
          <p className="mt-2">Click On The Button to Go to the Home Page</p>
          <Link to="/" className="btn btn-pool-choice active mt-3"><i className="arrow_left"></i> Back Home Page</Link>
        </div>
      </div>
    );
  }
